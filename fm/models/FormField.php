...
class FormField extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('FORM_ID, FIELD_SIZE, FIELD_SIZE_MIN, REQUIRED, POSITION, VISIBLE', 'numerical', 'integerOnly'=>true),
			...
			array('FIELD_ID, FORM_ID, VARNAME, TITLE, FIELD_TYPE, FIELD_SIZE, FIELD_SIZE_MIN, REQUIRED, MATCH, RANGE, ERROR_MESSAGE, OTHER_VALIDATOR, DEFAULT, WIDGET, WIDGETPARAMS, POSITION, VISIBLE, CREATED_BY, LAST_MODIFIED_BY, CREATED_DATE, LAST_MODIFIED_DATE', 'safe', 'on'=>'search'),
			//Tracking
